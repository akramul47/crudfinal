                ...
                <table class="table">
                    ...
                    foreach ($banners as $banner):
                        ...
                        <tr>
                            ...
                            <td><td><a href="show.php?id=<?=$banner['id'];?>">Show</a> |<a href="edit.php?id=<?=$banner['id'];?>">Edit</a>  | <a href="delete.php?id=<?=$banner['id'];?>" onclick="return confirm('are you sure you want to delete?')">Delete</a></td></td>
                        </tr>
                        <?php
                    endforeach;
                    else:
